...
class Categories:
    ...
    def display_categories(cls):
        try:
            categories = cls.load_categories()
    ...
    @classmethod
    def create_category(cls, cat):
        """ Creates a new category object and adds it to the categories collection """
        cls.add_category(category.Category(cat))

    @classmethod

    def delete_category(cls, cat):
        """ Removes a category from the categories collection """
        cls.remove_category(category.Category(cat))
